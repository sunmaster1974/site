...
<head>
	...
	<meta name="description" content="Такси LARGUS Самара. Детское такси по Самаре и области. От 1 до 4 детских кресел" />
	<meta name="keywords" content="Детское такси LARGUS Самара" />

	<title>Детское такси LARGUS в Самаре от 1 до 4 детских кресел</title>


	<link type="image/x-icon" href="templates/landkit/favicon-6--3.ico" rel="shortcut icon" />
	<link type="image/x-icon" href="templates/landkit/favicon-6--3.ico" rel="icon" />
...
<header class="header" id="main">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
				<a href="/detskoe-taksi.php">
				<img class="logo2" src="/templates/landkit/images/logo-1.png" alt="VipTaxiSonata">
				</a>
			</div>

			<div class="col-md-6 text-center">
				<h1>Такси LARGUS Самара.</h1> <h2>Детское такси по Самаре и области</h2>
			</div>
    ...
    <div class="modal-content">
		...
		<div class="modal-body">
		  <form action="#" method="post" id="user_contact" name="user_contact">
			...
			<input type="hidden" name="form_name" value="Детское такси (всплывающая форма)" />
...
<section id="deti">
  	<div class="container-fluid">
        <div class="col-md-6">
		<div class="features text-light text-uppercase">
          <div class="wow fadeInLeft">
            <div class="feature-img"><img src="/templates/landkit/images/features/i3-6.png" alt="Безопасность"/></div>
            <h3>До 5 детских кресел</h3>            
          </div>			
        </div>	
			
		<div class="text-center taxi">
          <img src="/templates/landkit/images/features/taxi1.png" alt="Безопасность" class="img-responsive wow fadeInLeft">          
        </div>
		</div>
	    <div class="col-md-6">
			<img src="/templates/landkit/images/deti/detskoe-taxi1.jpg" alt="Безопасность" class="img-responsive wow fadeInRight">
		</div>
	</div>
</section>
...
<!--Features-->
	...
	<div class="container">
		<div class="row text-center">
			<h2 text-uppercase>Такси LARGUS Самара – удобно для пассажиров с детьми</h2>          
		</div>
	</div>
                   ...
                   <div class="mail-form text-center wow fadeIn">
					   ...
					   <div id="div_contact2">
                      	 <form id="user_contact" name="user_contact" action="#" method="post">
							...
							<input class="wow flipInX required" type="text" id="user_childs" name="user_childs" placeholder="Количество детей до 7 лет*">
							<input class="wow flipInX required" type="text" id="user_adults" name="user_adults" placeholder="Количество взрослых*">
						    <input type="hidden" name="form_name" 	value="Детское такси (встроенная форма)">
                           	<input type="hidden" name="user_time" 	value="yes">
							<input type="hidden" name="user_agent" 	value="yes">
							<input type="hidden" name="user_ip" 	value="yes">
							<input type="hidden" name="user_referrer" value="yes">
