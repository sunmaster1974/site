...
<head>
	...
	<meta name="description" content="Такси LARGUS Самара. Шестиместное такси по Самаре и Самарской области" />
	<meta name="keywords" content="Шестиместное 6-местное такси LARGUS Самара" />

	<title>Шестиместное такси LARGUS Самара</title>


	<link type="image/x-icon" href="templates/landkit/favicon-6--4.ico" rel="shortcut icon" />
	<link type="image/x-icon" href="templates/landkit/favicon-6--4.ico" rel="icon" />
...
<!--Features-->
    <section id="features">
		...
		<div class="row text-center taxi">
          <img src="/templates/landkit/images/largus-2019-1.png" alt="Безопасность"/>          
        </div>		
...
<div id="callback" class="clearfix">
                   ...
                   <div class="mail-form text-center wow fadeIn">
					   ...
					   <div id="div_contact2">
                      	 <form id="user_contact" name="user_contact" action="#" method="post">
						    ...
						    <input type="hidden" name="form_name" value="Шестиместное такси (встроенная форма)">
                           	<input type="hidden" name="user_time" value="yes">
							<input type="hidden" name="user_agent" value="yes">
							<input type="hidden" name="user_ip" value="yes">
							<input type="hidden" name="user_referrer" value="yes">
	...
	<div id="gallery">
		<div class="container">
			<div class="row"> 
				<div class="col-sm-3">
					<a href="/templates/landkit/images/6mest-4.jpg" data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/6mest-4sm.jpg" class="img-responsive"></a>
				</div>
				<div class="col-sm-3">
			...
			<div class="row"> 
				<div class="col-sm-3">
					<a href="/templates/landkit/images/6mest-6.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/6mest-6sm.jpg" class="img-responsive"></a>
				</div>
				<div class="col-sm-3">
				...
				<div class="col-sm-3">
					<a href="/templates/landkit/images/6mest-7.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/6mest-7sm.jpg" class="img-responsive"></a>
				</div>
				<div class="col-sm-3">
