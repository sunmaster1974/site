<?php /* Smarty version Smarty-3.1.19, created on 2018-04-17 19:09:41
         compiled from "smarty/templates/admin.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20427633225ad60e35677c06-08216132%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4422580bf04cc4b213bc08b33e3d20f0d3127af1' => 
    array (
  ...
  'nocache_hash' => '20427633225ad60e35677c06-08216132',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ad60e3684c494_77979701',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ad60e3684c494_77979701')) {function content_5ad60e3684c494_77979701($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'smarty/plugins/modifier.capitalize.php';
?><div id="top_panel">
	<ul id="user_list">
		<li>
...
<?php if ($_smarty_tpl->tpl_vars['page']->value=="orders") {?>
	...
	<?php if ($_smarty_tpl->tpl_vars['type']->value!="errors") {?>
			<tr>
				<th width="10%">Дата</th>
				<th width="10%">Форма</th>
				<th width="10%">Имя</th>
				<th width="15%">Электронная почта</th>
...
?>
			<tr style="font-weight: <?php if ($_smarty_tpl->tpl_vars['orders']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['status']==0) {?>bold<?php } else { ?>normal<?php }?>;">          
				...
				<td><?php echo $_smarty_tpl->tpl_vars['orders']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['phone'];?>
</td>
...
');" title="Удалить заявку из таблицы">&nbsp;X&nbsp;</a></td>
		...
		<?php } else { ?>
			<tr>
				<td colspan="8" class="no_rows">Заявок нет</td>
			</tr>
		<?php }?>
	<?php } else { ?>
			<tr>
