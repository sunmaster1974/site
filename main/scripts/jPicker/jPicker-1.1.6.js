      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          ...
          tooltips:
          {
            colors:
            {
              newColor: 'Нажмите «Выбрать», чтобы выбрать новый цвет',
              currentColor: 'Щёлкните по цвету, чтобы вернуться к исходному цвету'
            },
            buttons:
            {
              ok: 'Подтвердить свой выбор нового цвета',
              cancel: 'Закрыть окно и вернуть исходный цвет'
            },
            hue:
            {
              radio: 'Щёлкните для установления цветового режима тона',
              textbox: 'Введите или измените стрелками значение тона (0-360&deg;)'
            },
            saturation:
            {
              radio: 'Щёлкните для установления цветового режима насыщенности',
              textbox: 'Введите или измените стрелками значение насыщенности (0-100%)'
            },
            value:
            {
              radio: 'Щёлкните для установления цветового режима интенсивности',
              textbox: 'Введите или измените стрелками значение интенсивности (0-100%)'
            },
            red:
            {
              radio: 'Щёлкните для установления цветового режима красного цвета',
              textbox: 'Введите или измените стрелками количество красного цвета (0-255)'
            },
            green:
            {
              radio: 'Щёлкните для установления цветового режима зелёного цвета',
              textbox: 'Введите или измените стрелками количество зелёного цвета(0-255)'
            },
            blue:
            {
              radio: 'Щёлкните для установления цветового режима синего цвета',
              textbox: 'Введите или измените стрелками количество синего цвета (0-255)'
            },
            alpha:
            {
              radio: 'Щёлкните для установления цветового режима прозрачности',
              textbox: 'Введите или измените стрелками значение прозрачности (0-100)'
            },
            hex:
            {
              textbox: 'Введите шестнадцатизначное значение цвета (#000000-#ffffff)',
              alpha: 'Введите шестнадцатизначное значение прозрачности (#00-#ff)'
            }
          }
        }
    };
