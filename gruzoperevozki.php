<?php require "/home/a/alshayx0/taxilargus.ru/public_html/main/session_db.php"; ?><!doctype html>
<html lang="ru">
<head>
	<meta charset="utf-8" />
	<meta name="generator" content="WebWertex LandKit (Landing page constructor 1.0)" />
	<meta name="description" content="Такси LARGUS Самара. Грузоперевозки до 700 кг по Самаре и Самарской области" />
	<meta name="keywords" content="такси LARGUS Самара грузоперевозки 700 кг" />

	<title>Грузоперевозки до 700 кг в такси LARGUS Самара</title>


	<link type="image/x-icon" href="templates/landkit/favicon-6--1.ico" rel="shortcut icon" />
	<link type="image/x-icon" href="templates/landkit/favicon-6--1.ico" rel="icon" />
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-1NND4RP138"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	
	  gtag('config', 'G-1NND4RP138');
	</script>

	<link type="text/css" href="/templates/landkit/styles/index.css" rel="stylesheet" />
...
<header class="header" id="main">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
				<a href="/gruzoperevozki.php">
				<img class="logo2" src="/templates/landkit/images/logo-1.png" alt="VipTaxiSonata">
				</a>
			</div>

			<div class="col-md-6 text-center">
				<h1>Такси LARGUS Самара.</h1> <h2>Грузоперевозки до 700 кг по Самаре и области</h2>
			</div>
    ...
    <div class="modal-content">
		...
		<div class="modal-body">
		  <form action="#" method="post" id="user_contact" name="user_contact">
			...
			<input type="hidden" name="form_name" value="Грузовое такси (всплывающая форма)" />
...
<!--Features-->
    <section id="features">
		...
		<div class="col-md-8">
          <img src="/templates/landkit/images/features/taxi1md.png" alt="Безопасность" class="img-responsive">
		</div>
		<div class="col-md-4">
          <img src="/templates/landkit/images/features/taxi1gruz.png" alt="Безопасность" class="img-responsive">
		</div>												
        </div>		
...
<div id="callback" class="clearfix">
                   ...
                   <div class="mail-form text-center wow fadeIn">
					   ...
					   <div id="div_contact2">
                      	 <form id="user_contact" name="user_contact" action="#" method="post">
						    ...
						    <input type="hidden" name="form_name" value="Заказать такси (встроенная форма)">
                           	<input type="hidden" name="user_time" value="yes">
							<input type="hidden" name="user_agent" value="yes">
							<input type="hidden" name="user_ip" value="yes">
							<input type="hidden" name="user_referrer" value="yes">
    ...
    <section class="page-block less-space-bottom" id="charts">
        ...
        <div class="row page-header">
          <h2>Наши услуги</h2>
          <span>Вам нужно доставить приобретенную бытовую технику? Ваш багаж не умещается в обычное такси? Нужен трансфер до аэропорта? Транспортировка негабаритных товаров? Мы Вам поможем! Такси LARGUS Самара – идеальное решение для перевозок небольших грузов или объемного багажа! 1.    Перевозка LCD до 65''; 2. Холодильники до 180 см; 3. Стиральные машины; 4 Другая мелкобытовая техника; 5 строительные материалы</span>
        </div>
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 chart">
            ...
            <p>
				Мы примем Ваш груз согласно предоставленной заранее Вашей описи, проверим наличие и целостность поставки.  Доставим груз по указанному Вами адресу.
			  </p>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 chart">
			 <div class="img">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 chart">
            ...
            <p>
				Вы можете поручить нам транспортировку товара от одного лица к другому в пределах Самарской области. Гарантируем сохранность груза и конфиденциальность.
			  </p>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 chart">
			<div class="img">
	...
	<div id="gallery">
		<div class="container">
			<div class="row"> 
				<div class="col-sm-3">
					<a href="/templates/landkit/images/gruz-gal01.jpg" data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/gruz-gal01sm.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-sm-3">
					<a href="/templates/landkit/images/gruz-gal02.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/gruz-gal02sm.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-sm-3">
					<a href="/templates/landkit/images/viber-image03.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/viber-image03-r.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-sm-3">
					<a href="/templates/landkit/images/viber-image04.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/viber-image04-r.jpg" class="img-responsive" alt=""></a>
				</div>
			</div>
			<p>
				&nbsp;
			...
			<div class="row"> 
				<div class="col-sm-3">
					<a href="/templates/landkit/images/viber-image05.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/viber-image05-r.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-sm-3">
					<a href="/templates/landkit/images/viber-image06.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/viber-image06-r.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-sm-3">
					<a href="/templates/landkit/images/viber-image07.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/viber-image07-r.jpg" class="img-responsive" alt=""></a>
				</div>
				<div class="col-sm-3">
					<a href="/templates/landkit/images/viber-image08.jpg"  data-lightbox="lbox" class="lbox"><img src="/templates/landkit/images/viber-image08-r.jpg" class="img-responsive" alt=""></a>
				</div>
			</div>
		</div>
	</div> <!-- #gallery -->
