...
<head>
	...
	<meta name="description" content="Такси ЛАРГУС в Самаре" />
	<meta name="keywords" content="заказать такси, такси в Самаре" />

	<title>Такси ЛАРГУС</title>


	<link type="image/x-icon" href="templates/landkit/favicon-6-.ico" rel="shortcut icon" />
	<link type="image/x-icon" href="templates/landkit/favicon-6-.ico" rel="icon" />
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 text-center">
				<h1>Такси LARGUS Самара.</h1> <h2>Грузовые и пассажирские перевозки по Самаре и области</h2>
			</div>
    ...
    <div class="modal-content">
		...
		<div class="modal-body">
		  <form action="#" method="post" id="user_contact" name="user_contact">
			...
			<input type="hidden" name="form_name" value="Заказать такси (всплывающая форма)" />
