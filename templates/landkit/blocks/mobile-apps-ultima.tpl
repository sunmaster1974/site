    ...
    <section class="page-block mobile-apps" id="apps">
        ...
        <div class="row">
          	...
          	<div class="row">
            	<div class="col-lg-12 col-md-12 col-sm-12">
              	<div class="row space-bottom">
                    ...
                    <img class="img-center" src="templates/landkit/images/apps-icon.png" alt="Mobile Apps"/>
                  </div>
                </div>
                <div class="row">
          ...
          <div class="col-lg-8 col-md-8">
            <img class="double-space-top" src="templates/landkit/images/tablet.png" alt="Mobile Apps"/>
          </div>
        </div>
      </div>
    </section>