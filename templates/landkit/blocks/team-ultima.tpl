    ...
    <section class="page-block team" id="team">
        ...
        <div class="row">
            ...
            <img class="img-circle-thumbnail img-center" src="templates/landkit/images/team/dirk.jpg" alt="Dexter Dirk"/>
            <h3>Dexter Dirk</h3>
            <p>Senior designer</p>
        	...
        	<div class="col-lg-3 col-md-3 col-sm-3">
            <img class="img-circle-thumbnail img-center" src="templates/landkit/images/team/roe.jpg" alt="Alexander Roe"/>
            <h3>Alexander Roe</h3>
        	...
        	<div class="col-lg-3 col-md-3 col-sm-3">
            <img class="img-circle-thumbnail img-center" src="templates/landkit/images/team/davis.jpg" alt="Susanna Davis"/>
            <h3>Susanna Davis</h3>
            <p>Art director</p>
            <div class="social-networks">
        	...
        	<div class="col-lg-3 col-md-3 col-sm-3">
            <img class="img-circle-thumbnail img-center" src="templates/landkit/images/team/doe.jpg" alt="Jonathan Doe"/>
            <h3>Jonathan Doe</h3>
