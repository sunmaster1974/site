...
<section class="hero" style="background: #ff6f69 url(templates/landkit/images/bg-art.png) no-repeat center top;">
	<div class="container">
	  ...
	  <div class="hero-slider">
		<div class="slide first-slide">
		  ...
		  <div class="col-lg-7 col-md-7 col-sm-7 animated">
			<img class="pull-right" src="templates/landkit/images/hero-slider/imac.png" width="689" height="659" alt="Components and Styles"/>
		  </div>
		</div>
		...
		<div class="slide">
		  ...
		  <div class="col-lg-7 col-md-7 col-sm-7 animated fadeInRight">
			<img class="iphone" src="templates/landkit/images/hero-slider/iphone.png" width="649" height="400" alt="Coming Soon Page"/>
		  </div>
		</div>
		...
		<div class="slide">
		  ...
		  <div class="col-lg-8 col-md-8 col-sm-8 animated fadeInRight">
			<div class="video">
			  <img src="templates/landkit/images/hero-slider/macbook.png" width="782" height="422" alt=""/>
			  <div class="vide-holder">
				<iframe src="https://player.vimeo.com/video/143512551?title=0&byline=0&portrait=0" width="720" height="405"></iframe>
			  </div>
			</div>
		  </div>
		</div>
