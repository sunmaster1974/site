    ...
    <section id="features">
        ...
        <div class="row features text-light text-uppercase">
          <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInLeft">
            <div class="feature-img"><img src="{$string-51}" alt="Низкие тарифы"/></div>
            <h3>Низкие тарифы</h3>			  
          </div>
			
          <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInDown">
            <div class="feature-img"><img src="{$string-52}" alt="Минимальное время ожидания"/></div>
            <h3>Минимальное время&nbsp;ожидания</h3>            
          </div>
			
          <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInRight">
            <div class="feature-img"><img src="{$string-53}" alt="Безопасность"/></div>
            <h3>Безопасность</h3>            
          </div>
			
        </div>
		<div class="row text-center taxi">
          <img src="{$string-54}" alt="Безопасность"/>          
        </div>		
